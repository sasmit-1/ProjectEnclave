...
Whenever we complete a micro-step, feature, or resolve a major bug, we will create a markdown file in this folder to document what was done.

## How to use this folder:
- **Format:** `YYYY-MM-DD_feature_or_step_completed.md`
